...
Page({
  ...
  zhinengtuijiansearch: function(e) {
    ...
    //请求搜索
    wx.request({
      url: 'http://shg.yuf2.cn/shg-api/api/product/other/list?keyword=' + that.data.inputValue.trim() + '&page=1&pageRows=10&sortType=time',
      data: {},
      header: {},
      method: 'GET',
      dataType: '',
  ...
  zhinengtuijianloadMore: function(e) {
    setTimeout(() => {
      ...
      var pageRows = 10;
      wx.request({
        url: 'http://shg.yuf2.cn/shg-api/api/product/other/list?keyword=' + that.data.inputValue.trim() + '&page=' + (++that.data.zhinengtuijianpage) + '&pageRows=' + pageRows + '&sortType=time',
        method: 'GET',
        success: function(res) {
  ...
  zhinengtuijianrefesh: function(e) {
    ...
    var pageRows = 10;
    wx.request({
      url: 'http://shg.yuf2.cn/shg-api/api/product/other/list?keyword=' + that.data.inputValue.trim() + '&page=1&pageRows=' + pageRows + '&sortType=time',
      method: 'GET',
      success: function(res) {
        // console.log(res.data);
        if (res.statusCode == 200) {
  ...
  jianglizuigaosearch: function(e) {
    var that = this;
    wx.request({
      url: 'http://shg.yuf2.cn/shg-api/api/product/other/list',
      data: {
