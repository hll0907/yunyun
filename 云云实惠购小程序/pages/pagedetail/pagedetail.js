...
Page({
  ...
  onclickaddLike: function(e) {
    ...
    wx.request({
      url: 'https://shg.yuf2.cn/shg-api/api/product/collect?userId=' + that.data.userId + '&productId=' + productId,
      header: {
  ...
  onclickdelLike: function(e) {
    ...
    // console.log(productId);
    wx.request({
      url: 'https://shg.yuf2.cn/shg-api/api/product/uncollect?userId=' + that.data.userId + '&productIds=' + productId,
      header: {
        "Content-Type": "application/x-www-form-urlencoded"
      },
      method: 'POST',
  ...
  onclickconvert_url: function(e) {
    ...
    wx.request({
      url: 'https://shg.yuf2.cn/shg-api/api/product/convert_url?productId=' + productId + '&couponUrl=' + couponUrl,
      header: {
        "Content-Type": "application/x-www-form-urlencoded"
      },
      method: 'POST',
  ...
  maketaobaocommand: function(e) {
    var that = this;
    var shopname = encodeURIComponent(that.data.shopname);
    var logoUrl = encodeURIComponent(that.data.logoUrls);
    var convert_url = encodeURIComponent(that.data.convert_urls);
    wx.request({
      url: 'https://shg.yuf2.cn/shg-api/api/product/tpwd?text=' + shopname + '&url=' + convert_url + '&logoUrl=' + logoUrl,
      method: 'GET',
